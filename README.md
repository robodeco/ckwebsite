...
<li>UPDATE: There have been no changes to the documentation. issue may be that the associated account has exceeded monthly alloted bandwidth, rather than API calls. Switching to new video player.</li>
 </ol>
